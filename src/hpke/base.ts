...
export function makeDHKEM(dhGroup: DH, kdf: KDF, kemId: number): KEM {
    ...
    class PublicKey extends KEMPublicKey {
        ...
        async encapsulate(ikm?: Uint8Array | undefined): Promise<[Uint8Array, Uint8Array]> {
    ...
    class PrivateKey extends KEMPrivateKey {
        ...
        serialize(): Promise<Uint8Array> { return this.dhPrivKey.serialize(); }
    ...
    return {
        ...
        async deserializePublic(enc: Uint8Array): Promise<KEMPublicKey> {
            const publicKey = await dhGroup.deserializePublic(enc);
            return new PublicKey(publicKey);
        },
        async deserializePrivate(enc: Uint8Array): Promise<KEMPrivateKey> {
...
export class HPKE {
    ...
    private async keySchedule(
        ...
        const secret = await labeledExtract(
            this.kdf, this.suiteId, sharedSecret, SECRET, psk,
        );
        ...
        const nonce = await labeledExpand(
            this.kdf, this.suiteId,
            secret, BASE_NONCE, keyScheduleContext, this.aead.nonceLength,
        );
     ...
     */
    async setupBaseS(pkR: KEMPublicKey, info: Uint8Array, ikmE?: Uint8Array): Promise<[Uint8Array, Context]> {
